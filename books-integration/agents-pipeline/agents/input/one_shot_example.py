...
all_rb_correspondences = pd.concat(
    [rb_correspondences_k2u, rb_correspondences_k2y], ignore_index=True
)
...
strategy.add_attribute_fuser(
    "house_number", prefer_higher_trust, trust_key="trust_score"
)
...
strategy.add_attribute_fuser(
    "postal_code", prefer_higher_trust, trust_key="trust_score"
)
