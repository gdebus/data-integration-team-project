...
all_rb_correspondences = post_clusterer.cluster(all_rb_correspondences)
...
strategy.add_attribute_fuser("name", voting)
strategy.add_attribute_fuser("name_norm", voting)
strategy.add_attribute_fuser("website", prefer_higher_trust, trust_map=global_trust_map)
strategy.add_attribute_fuser("map_url", voting)
strategy.add_attribute_fuser("address_line1", voting)
strategy.add_attribute_fuser("address_line2", most_complete)
strategy.add_attribute_fuser("street", voting)
strategy.add_attribute_fuser("house_number", voting)
strategy.add_attribute_fuser("city", prefer_higher_trust, trust_map=global_trust_map)
strategy.add_attribute_fuser("state", prefer_higher_trust, trust_map=global_trust_map)
strategy.add_attribute_fuser("postal_code", voting)
strategy.add_attribute_fuser("country", prefer_higher_trust, trust_map=global_trust_map)

strategy.add_attribute_fuser("phone_raw", prefer_higher_trust, trust_map=global_trust_map)
strategy.add_attribute_fuser("phone_e164", prefer_higher_trust, trust_map=global_trust_map)
