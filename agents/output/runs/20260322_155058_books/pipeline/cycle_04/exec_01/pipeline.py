...
# === 7. POST-CLUSTERING ===
refined_correspondences_amazon_goodreads = MaximumBipartiteMatching().cluster(
    rb_correspondences_amazon_goodreads
)
refined_correspondences_amazon_metabooks = rb_correspondences_amazon_metabooks
refined_correspondences_goodreads_metabooks = rb_correspondences_goodreads_metabooks
...
trust_map_title = {"goodreads_small": 3, "metabooks_small": 2, "amazon_small": 1}
trust_map_publisher = {"metabooks_small": 3, "goodreads_small": 2, "amazon_small": 1}
trust_map_page_count = {"metabooks_small": 3, "goodreads_small": 2, "amazon_small": 1}
trust_map_protected = {"amazon_small": 3, "goodreads_small": 2, "metabooks_small": 2}
...
strategy.add_attribute_fuser("isbn_clean", prefer_higher_trust, trust_map=trust_map_protected)

strategy.add_attribute_fuser("publish_year", prefer_higher_trust, trust_map=trust_map_protected)
...
strategy.add_attribute_fuser("genres", most_complete, separator="; ")
