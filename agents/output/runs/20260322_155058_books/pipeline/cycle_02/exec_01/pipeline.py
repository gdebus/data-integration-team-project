...
refined_amazon_goodreads = MaximumBipartiteMatching().cluster(rb_correspondences_amazon_goodreads)
refined_amazon_metabooks = rb_correspondences_amazon_metabooks
refined_goodreads_metabooks = rb_correspondences_goodreads_metabooks

all_rb_correspondences = pd.concat(
    [
        refined_amazon_goodreads,
        refined_amazon_metabooks,
        refined_goodreads_metabooks,
    ],
    ignore_index=True,
)
...
trust_map = {"amazon_small": 1, "goodreads_small": 2, "metabooks_small": 3}
page_count_trust_map = {"amazon_small": 3, "goodreads_small": 2, "metabooks_small": 1}

strategy = DataFusionStrategy("fusion_strategy")

trust_map_publisher = {"metabooks_small": 3, "goodreads_small": 2, "amazon_small": 1}
trust_map_title = {"metabooks_small": 3, "goodreads_small": 2, "amazon_small": 1}
trust_map_page_count = {"amazon_small": 3, "goodreads_small": 2, "metabooks_small": 1}
strategy.add_attribute_fuser("title", prefer_higher_trust, trust_map=trust_map_title)
...
strategy.add_attribute_fuser("isbn_clean", prefer_higher_trust, trust_map={"amazon_small": 3, "goodreads_small": 2, "metabooks_small": 2})

strategy.add_attribute_fuser("publish_year", prefer_higher_trust, trust_map={"amazon_small": 3, "goodreads_small": 2, "metabooks_small": 2})
strategy.add_attribute_fuser("rating", median)
strategy.add_attribute_fuser("numratings", maximum)
strategy.add_attribute_fuser("page_count", prefer_higher_trust, trust_map=trust_map_page_count)
strategy.add_attribute_fuser("price", median)

strategy.add_attribute_fuser("language", prefer_higher_trust, trust_map={"amazon_small": 3, "goodreads_small": 2, "metabooks_small": 2})
strategy.add_attribute_fuser("bookformat", most_complete)
strategy.add_attribute_fuser("edition", most_complete)

strategy.add_attribute_fuser("genres", prefer_higher_trust, trust_map={"goodreads_small": 3, "amazon_small": 2, "metabooks_small": 1})
