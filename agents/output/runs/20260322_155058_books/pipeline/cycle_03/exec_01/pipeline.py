...
all_rb_correspondences = MaximumBipartiteMatching().cluster(all_rb_correspondences)

# === 8. DATA FUSION ===
print("Fusing Data")

trust_map = {"amazon_small": 3.000, "goodreads_small": 2.000, "metabooks_small": 1.000}

strategy = DataFusionStrategy("fusion_strategy")

strategy.add_attribute_fuser("title", prefer_higher_trust, trust_map={"metabooks_small": 1.000, "goodreads_small": 2.000, "amazon_small": 3.000})
strategy.add_attribute_fuser("author", longest_string)
strategy.add_attribute_fuser("publisher", most_complete)
...
strategy.add_attribute_fuser("page_count", prefer_higher_trust, trust_map={"metabooks_small": 1.000, "goodreads_small": 2.000, "amazon_small": 3.000})
...
strategy.add_attribute_fuser("genres", most_complete)
