...
from PyDI.fusion import (
    ...
    voting, most_complete, median, average, union,
    prefer_higher_trust,
)
...
# === 2. SCHEMA MATCHING ===
# Datasets are already schema-aligned from the normalization step.
...
comparators_kaggle_small_yelp_small = [
    StringComparator(column="phone_e164", similarity_function="jaro_winkler", list_strategy="concatenate"),
    StringComparator(column="name_norm", similarity_function="cosine", preprocess=lower_strip, list_strategy="concatenate"),
