...
# === 6. POST-CLUSTERING ===
clustered_correspondences = pd.concat(
    [
        MaximumBipartiteMatching().cluster(corr_forbes_dbpedia),
        MaximumBipartiteMatching().cluster(corr_forbes_fullcontact),
        MaximumBipartiteMatching().cluster(corr_fullcontact_dbpedia),
    ],
    ignore_index=True,
)
...
trust_map_founded = {"fullcontact": 3, "dbpedia": 2, "forbes": 1}
