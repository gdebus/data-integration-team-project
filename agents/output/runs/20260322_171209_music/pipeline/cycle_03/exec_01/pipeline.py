...
from PyDI.fusion import voting
...
trust_map = {"musicbrainz": 1.000, "discogs": 3.000, "lastfm": 2.000}
...
strategy.add_attribute_fuser("label", prefer_higher_trust, trust_map={"discogs": 3.000, "lastfm": 2.000, "musicbrainz": 1.000})
