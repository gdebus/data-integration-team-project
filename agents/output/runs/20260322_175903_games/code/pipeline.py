...
trust_map_general = {"dbpedia": 2, "metacritic": 3, "sales": 3}
trust_map_developer = {"dbpedia": 1, "metacritic": 4, "sales": 4}
trust_map_criticScore = {"dbpedia": 1, "metacritic": 2, "sales": 5}
trust_map_userScore = {"dbpedia": 1, "metacritic": 5, "sales": 2}
trust_map_ESRB = {"dbpedia": 1, "metacritic": 5, "sales": 3}

strategy = DataFusionStrategy("fusion_strategy")

strategy.add_attribute_fuser("name", voting)
strategy.add_attribute_fuser("releaseYear", earliest)
strategy.add_attribute_fuser("developer", voting)
strategy.add_attribute_fuser("platform", voting)
strategy.add_attribute_fuser("series", prefer_higher_trust, trust_map=trust_map_general)
strategy.add_attribute_fuser("criticScore", voting)
strategy.add_attribute_fuser("userScore", voting)
strategy.add_attribute_fuser("ESRB", voting)
strategy.add_attribute_fuser("publisher", voting)
strategy.add_attribute_fuser("globalSales", prefer_higher_trust, trust_map=trust_map_general)
