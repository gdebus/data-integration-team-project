...
refined_dbpedia_metacritic = clusterer.cluster(rb_correspondences_dbpedia_metacritic)
refined_dbpedia_sales = clusterer.cluster(rb_correspondences_dbpedia_sales)
refined_metacritic_sales = clusterer.cluster(rb_correspondences_metacritic_sales)
...
release_year_trust_map = {"dbpedia": 1, "metacritic": 5, "sales": 4}
developer_trust_map = {"dbpedia": 1, "metacritic": 4, "sales": 4}
publisher_trust_map = {"dbpedia": 1, "metacritic": 2, "sales": 5}
esrb_trust_map = {"dbpedia": 1, "metacritic": 5, "sales": 3}
user_score_trust_map = {"dbpedia": 1, "metacritic": 5, "sales": 2}

strategy = DataFusionStrategy("fusion_strategy")

trust_map_releaseYear = {"metacritic": 5, "sales": 4, "dbpedia": 1}
trust_map_userScore = {"metacritic": 2, "sales": 1}
trust_map_developer = {"metacritic": 4, "sales": 4, "dbpedia": 1}
trust_map_publisher = {"sales": 1}
trust_map_criticScore = {"sales": 2, "metacritic": 1}
trust_map_ESRB = {"metacritic": 5, "sales": 3, "dbpedia": 1}
...
strategy.add_attribute_fuser("developer", prefer_higher_trust, trust_map=trust_map_developer)
...
strategy.add_attribute_fuser("userScore", prefer_higher_trust, trust_map=trust_map_userScore)
...
strategy.add_attribute_fuser("globalSales", prefer_higher_trust, trust_map=trust_map)
